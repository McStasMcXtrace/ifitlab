"""
Django settings for iflproj project.
...
WSGI_APPLICATION = 'iflproj.wsgi.application'
...
STATIC_URL = '/ifl/ifl-static/'
STATIC_ROOT = '/srv/mcweb/ifitlab/iflproj/static/'
